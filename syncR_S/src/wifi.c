...
static uint32_t wifi_rate = WIFI_PHY_RATE_11M_L;
static uint32_t bandwidth = WIFI_BW_HT20;
static uint32_t max_tx_power = 80;  // 20 dBm
...
void initialize_promiscuous(void) {
